...
make O=/home/skye/bomb/out ARCH=arm64 LLVM=1 LLVM_IAS=1 "${MAKE_OPT[@]}"vendor/bengal-perf_defconfig vendor/lito-perf_defconfig vendor/kona_defconfig vendor/kona-sec-perf_defconfig vendor/samsung/x1q.config
